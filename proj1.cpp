...
Display( )
{
	...
	glTranslatef(0, 0, hexHeight / 2);
	glRotatef(90., 0, 0, 1);
	displayShine(0, -HEXSIZE / 2, -HEXSIZE + hexHeight, true);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(0, 0, -hexHeight / 2);
	glRotatef(90, 0, 0, 1.);
	displayShine(0, -HEXSIZE / 2, -HEXSIZE + hexHeight, false);
	glPopMatrix();
...
InitMenus( )
{
	...
	glutAddMenuEntry("Party Mode", PARTY);
